...
class Trainer:
    def __init__(self, configs):
        ...
        torch.manual_seed(5)
        self.network = SimVP(configs).to(configs.device)
...
if __name__ == '__main__':
    ...
    # net = torch.load('checkpoint_52.1768741607666.chk')
    ...
    # np.savez('result52.1768741607666.npz', pred=pred.cpu(), label=label.cpu())
