...
class Trainer:
    def __init__(self, configs):
        ...
        torch.manual_seed(5)
        self.network = MAU_Model(configs).to(configs.device)
...
if __name__ == '__main__':
    ...
    net = torch.load('checkpoint_53.857845306396484.chk')
    ...
    # np.savez('result53.857845306396484.npz', pred=pred.cpu(), label=label.cpu())
