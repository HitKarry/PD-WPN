...
class Trainer:
    def __init__(self, configs):
        ...
        torch.manual_seed(5)
        self.network = Earthfarseer_model(shape_in=(configs.input_length, configs.input_dim, configs.input_h, configs.input_w)).to(configs.device)
...
if __name__ == '__main__':
    ...
    # net = torch.load('checkpoint_52.22644805908203.chk')
    ...
    # np.savez('result52.22644805908203.npz', pred=pred.cpu(), label=label.cpu())
