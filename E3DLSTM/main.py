...
class Trainer:
    def __init__(self, configs):
        ...
        torch.manual_seed(5)
        self.network = E3DLSTM_Model(configs).to(configs.device)
...
if __name__ == '__main__':
    ...
    net = torch.load('checkpoint_55.11326026916504.chk')
    ...
    np.savez('result55.11326026916504.npz', pred=pred.cpu(), label=label.cpu())
